  ...
  //Setting Screen to show in Setting Option
    return (
      ...
      <View style={{marginTop:20, borderRadius:10, elevation:2, backgroundColor:'white', paddingTop:10, paddingLeft:10, width:'100%'}}>
        ...
        <TouchableOpacity onPress={()=>navigation.navigate('AdminInformationAccount')} style={{flexDirection:'row', marginVertical:20, marginHorizontal:10, alignItems:'center'}}>
      ...
      <View style={{marginTop:20, borderRadius:10, elevation:2, backgroundColor:'white', paddingTop:10, paddingLeft:10, width:'100%'}}>
        ...
        <TouchableOpacity onPress={()=>navigation.navigate('AdminAboutApplication')}   style={{flexDirection:'row', margin:10, alignItems:'center'}}>
        ...
        <TouchableOpacity onPress={()=>navigation.navigate('AdminPolicyPrivacy')} style={{flexDirection:'row', marginTop:20, marginBottom:10, marginHorizontal:10, alignItems:'center'}}>
        ...
        <TouchableOpacity onPress={()=>navigation.navigate('AdminTermsConditions')} style={{flexDirection:'row', marginVertical:20, marginHorizontal:10, alignItems:'center'}}>
